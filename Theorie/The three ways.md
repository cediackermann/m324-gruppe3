...
> **Auszufüllen durch die Gruppe** – der Lernauftrag verlangt Prompt, KI-Rückmeldung, geprüfte Aussage und eigene Schlussfolgerung.

| Prompt | Rückmeldung der KI | Geprüfte/korrigierte Aussage | Eigene Schlussfolgerung |
|---|---|---|---|
| *(eintragen)* | *(eintragen)* | *(anhand welcher Quelle?)* | *(eintragen)* |

**Werkzeug / Datum:** *(eintragen)* · **Art des Einsatzes:** Strukturierung und Ausformulierung der selbst erarbeiteten Kernaussagen. Die KI wurde nicht als Fachquelle verwendet.
